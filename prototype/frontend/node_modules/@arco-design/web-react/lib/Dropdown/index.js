...
function Dropdown(baseProps, _) {
    ...
    var renderPopup = function () {
        ...
        if ((_c = content === null || content === void 0 ? void 0 : content.props) === null || _c === void 0 ? void 0 : _c.isMenu) {
            var isEmpty = true;
            try {
                for (var _d = __values(react_1.default.Children.toArray(content.props.children)), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var child = _e.value;
