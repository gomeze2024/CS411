...
function addInstance(noticeProps) {
    ...
    if (messageInstance[position]) {
        ...
        (0, react_dom_1.render)(react_1.default.createElement(Message, { transitionClassNames: transitionClassNames, ref: function (instance) {
...
var Message = /** @class */ (function (_super) {
    ...
    Message.prototype.render = function () {
        var _this = this;
        var _a = this.props, transitionClassNames = _a.transitionClassNames, _prefixCls = _a.prefixCls, _rtl = _a.rtl;
        ...
        return (react_1.default.createElement("div", { className: classNames },
            react_1.default.createElement(react_transition_group_1.TransitionGroup, { component: null }, notices.map(function (notice) { return (react_1.default.createElement(react_transition_group_1.CSSTransition, { key: notice.id, timeout: {
                ...
                react_1.default.createElement(notice_1.default, __assign({}, notice, { prefixCls: prefixClsMessage, iconPrefix: mergedPrefixCls, onClose: _this.remove, noticeType: "message", rtl: mergedRtl })))); }))));
    };
