...
function Group(baseProps) {
    ...
    return (react_1.default.createElement(exports.RadioGroupContext.Provider, { value: contextProp },
        react_1.default.createElement("div", __assign({ className: classNames, role: "radiogroup", style: style }, (0, pick_1.pickDataAttributes)(props)), options && (0, is_1.isArray)(options)
